...
def main():
    ...
    #grid_search_clustering(clinedata, labels_cline, k_range, Npc_range,max_iter, datatype='clinedata', method='un_rtlda')
    #grid_search_clustering(clinedata, labels_cline, k_range, Npc_range,max_iter, datatype='clinedata', method='un_trlda')
    grid_search_clustering(clinedata, labels_cline, k_range, Npc_range,max_iter, datatype='clinedata', method='swulda')

    grid_search_clustering(clinedata, labels_cline, k_range, Npc_range,max_iter, datatype='clinedata', method='un_lda')
    grid_search_clustering(clinedata, labels_cline, k_range, Npc_range,max_iter, datatype='clinedata', method='un_kfdapc')
    grid_search_clustering(clinedata, labels_cline, k_range, Npc_range,max_iter, datatype='clinedata', method='un_rtalda')
    grid_search_clustering(clinedata, labels_cline, k_range, Npc_range,max_iter, datatype='clinedata', method='un_tralda')

    grid_search_clustering(clinedata, labels_cline, k_range, Npc_range,max_iter, datatype='clinedata', method='un_rtcdlda')
    grid_search_clustering(clinedata, labels_cline, k_range, Npc_range,max_iter, datatype='clinedata', method='un_trcdlda')
