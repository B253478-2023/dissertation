...
def main():
    ...
    #grid_search_clustering(insulardata, labels_insular, k_range, Npc_range,max_iter, datatype='insulardata', method='un_rtlda')
    #grid_search_clustering(insulardata, labels_insular, k_range, Npc_range, max_iter, datatype='insulardata', method='un_trlda')
    #grid_search_clustering(insulardata, labels_insular, k_range, Npc_range, max_iter, datatype='insulardata', method='swulda')

    #grid_search_clustering(insulardata, labels_insular, k_range, Npc_range, max_iter, datatype='insulardata', method='un_lda')
    #grid_search_clustering(insulardata, labels_insular, k_range, Npc_range, max_iter, datatype='insulardata', method='un_kfdapc')
    #grid_search_clustering(insulardata, labels_insular, k_range, Npc_range, max_iter, datatype='insulardata',method='un_rtalda')
    #grid_search_clustering(insulardata, labels_insular, k_range, Npc_range, max_iter, datatype='insulardata', method='un_tralda')
