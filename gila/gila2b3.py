...
def main():
    ...
    #grid_search_clustering(genotype_matrix, pop_labels, k_range, Npc_range, max_iter, datatype='gila2b_15', method='un_rtlda')
    #grid_search_clustering(genotype_matrix, pop_labels, k_range, Npc_range, max_iter, datatype='gila2b_15', method='un_trlda')
    grid_search_clustering(genotype_matrix, pop_labels, k_range, Npc_range, max_iter, datatype='gila2b_15', method='un_lda')

    #grid_search_clustering(genotype_matrix, pop_labels, k_range, Npc_range, max_iter, datatype='gila2b_15', method='un_rtalda')
    #grid_search_clustering(genotype_matrix, pop_labels, k_range, Npc_range, max_iter, datatype='gila2b_15', method='un_tralda')
    grid_search_clustering(genotype_matrix, pop_labels, k_range, Npc_range, max_iter, datatype='gila2b_15', method='swulda')

    #grid_search_clustering(genotype_matrix, pop_labels, k_range, Npc_range, max_iter, datatype='gila2b_15', method='un_rtcdlda')
    #grid_search_clustering(genotype_matrix, pop_labels, k_range, Npc_range, max_iter, datatype='gila2b_15', method='un_trcdlda')
    grid_search_clustering(genotype_matrix, pop_labels, k_range, Npc_range, max_iter, datatype='gila2b_15', method='un_kfdapc')
