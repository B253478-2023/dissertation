...
def main():
    ...
    grid_search_clustering(HierIslanddata, labels, k_range, Npc_range,max_iter, datatype='HierIsland', method='un_rtlda')
    grid_search_clustering(HierIslanddata, labels, k_range, Npc_range, max_iter, datatype='HierIsland', method='un_trlda')
    grid_search_clustering(HierIslanddata, labels, k_range, Npc_range, max_iter, datatype='HierIsland', method='swulda')
    grid_search_clustering(HierIslanddata, labels, k_range, Npc_range,max_iter, datatype='HierIsland',method='un_rtcdlda')
    grid_search_clustering(HierIslanddata, labels, k_range, Npc_range, max_iter, datatype='HierIsland', method='un_trcdlda')
    grid_search_clustering(HierIslanddata, labels, k_range, Npc_range, max_iter, datatype='HierIsland', method='un_lda')
    grid_search_clustering(HierIslanddata, labels, k_range, Npc_range,max_iter, datatype='HierIsland',method='un_rtalda')
    grid_search_clustering(HierIslanddata, labels, k_range, Npc_range, max_iter, datatype='HierIsland', method='un_tralda')
    grid_search_clustering(HierIslanddata, labels, k_range, Npc_range, max_iter, datatype='HierIsland', method='un_kfdapc')
