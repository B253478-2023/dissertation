...
def main():
    ...
    grid_search_clustering(Hiersteppingstonedata, labels, k_range, Npc_range,max_iter, datatype='Hiersteppingstone', method='un_rtlda')
    grid_search_clustering(Hiersteppingstonedata, labels, k_range, Npc_range, max_iter, datatype='Hiersteppingstone', method='un_trlda')
    grid_search_clustering(Hiersteppingstonedata, labels, k_range, Npc_range, max_iter, datatype='Hiersteppingstone', method='swulda')
    grid_search_clustering(Hiersteppingstonedata, labels, k_range, Npc_range,max_iter, datatype='Hiersteppingstone',method='un_rtcdlda')
    grid_search_clustering(Hiersteppingstonedata, labels, k_range, Npc_range, max_iter, datatype='Hiersteppingstone', method='un_trcdlda')
    grid_search_clustering(Hiersteppingstonedata, labels, k_range, Npc_range, max_iter, datatype='Hiersteppingstone', method='un_lda')
    grid_search_clustering(Hiersteppingstonedata, labels, k_range, Npc_range,max_iter, datatype='Hiersteppingstone',method='un_rtalda')
    grid_search_clustering(Hiersteppingstonedata, labels, k_range, Npc_range, max_iter, datatype='Hiersteppingstone', method='un_tralda')
    grid_search_clustering(Hiersteppingstonedata, labels, k_range, Npc_range, max_iter, datatype='Hiersteppingstone', method='un_kfdapc')
